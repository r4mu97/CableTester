...
#Region "Structures"
Public Structure TPCANOPEN
    Public node_ID As UInt32
    Public funcion_ID As UInt32


End Structure

Public Structure TPCANOPENMsg
    ''' <summary>
    ...
    Public MSGTYPE As TPCANOPENMessageType
    ''' <summary>
...
Module CAN_OPEN
    ...
    Public currChannel As TPCANHandle = 0
    Public currBaudrate As TPCANOPENBaudrate = TPCANOPENBaudrate.PCANOPENBAUD_500K
...
#Region "Members"
    ...
    ''' </summary>
    Private m_Baudrate As TPCANOPENBaudrate
    ''' <summary>
...
#Region "Enumerations"
    ...
    ''' </summary>
    Public Enum TPCANOPENBaudrate As UInt16
        ''' <summary>
        ''' 1 MBit/s
        ''' </summary>
        PCANOPENBAUD_1M = &H14
        ...
        ''' 800 kBit/s
        ''' </summary>
        PCANOPENBAUD_800K = &H16
        ''' <summary>
        ''' 500 kBit/s
        ''' </summary>
        PCANOPENBAUD_500K = &H1C
        ''' <summary>
        ''' 250 kBit/s
        ''' </summary>
        PCANOPENBAUD_250K = &H11C
        ''' <summary>
        ''' 125 kBit/s
        ''' </summary>
        PCANOPENBAUD_125K = &H31C
        ''' <summary>
        ''' 100 kBit/s
        ''' </summary>
        PCANOPENBAUD_100K = &H432F
        ''' <summary>
        ''' 95,238 kBit/s
        ''' </summary>
        PCANOPENBAUD_95K = &HC34E
        ''' <summary>
        ''' 83,333 kBit/s
        ''' </summary>
        PCANOPENBAUD_83K = &H852B
        ''' <summary>
        ''' 50 kBit/s
        ''' </summary>
        PCANOPENBAUD_50K = &H472F
        ''' <summary>
        ''' 47,619 kBit/s
        ''' </summary>
        PCANOPENBAUD_47K = &H1414
        ''' <summary>
        ''' 33,333 kBit/s
        ''' </summary>
        PCANOPENBAUD_33K = &H8B2F
        ''' <summary>
        ''' 20 kBit/s
        ''' </summary>
        PCANOPENBAUD_20K = &H532F
        ''' <summary>
        ''' 10 kBit/s
        ''' </summary>
        PCANOPENBAUD_10K = &H672F
        ''' <summary>
        ''' 5 kBit/s
        ''' </summary>
        PCANOPENBAUD_5K = &H7F7F
    End Enum
    ...
    Public Enum TPCANType As Byte
        ...
        ''' PCAN-ISA SJA1000
        ''' </summary>
        PCANOPENTYPE_ISA_SJA = &H9
        ''' <summary>
        ''' PHYTEC ISA 
        ''' </summary>
        PCANOPENTYPE_ISA_PHYTEC = &H4
        ''' <summary>
        ''' PCAN-Dongle 82C200
        ''' </summary>
        PCANOPENTYPE_DNG = &H2
        ...
        ''' </summary>
        PCANOPENTYPE_DNG_EPP = &H3
        ''' <summary>
        ''' PCAN-Dongle SJA1000
        ''' </summary>
        PCANOPENTYPE_DNG_SJA = &H5
        ''' <summary>
        ''' PCAN-Dongle EPP SJA1000
        ''' </summary>
        PCANOPENTYPE_DNG_SJA_EPP = &H6
    End Enum
#End Region
    ...
    ''' </summary>
    Public Sub InitializeBasicComponentsCanOpen()
    ...
    Public Function init_CANOPEN(channel As TPCANHandle, bitrate As TPCANOPENBaudrate, Optional xFilterMessagesForLECUComm As Boolean = True) As Boolean
        Try
    ...
    Public Function unInit_CANOPEN() As Boolean
        Try
    ...
    Public Function getAvailableCanOpenChannels() As TPCANHandle()
        Try
...
Public Enum TPCANOPENMessageType As Byte
    ''' <summary>
    ''' The PCAN message is a CAN Standard Frame (11-bit identifier)
    ''' </summary>
    PCAN_MESSAGE_STANDARD = &H0
