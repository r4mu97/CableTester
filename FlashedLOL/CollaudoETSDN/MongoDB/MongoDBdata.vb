...
Public Class MongoDBdata
    Function commitDeviceCraft(gui As Main) As Boolean
        'Try
        '    gui.ChangeControlRichText(gui.RichTextBox1, "Progress data on cloud", 4)
        ...
        '    gui.ChangeControlRichText(gui.RichTextBox1, params.GetElement("Device").Value.AsBsonDocument().GetElement("serial").Value.ToString() & " - Completato", 2)
        '    Return True

        'Catch ex As Exception
        '    gui.ChangeControlRichText(gui.RichTextBox1, "error submit data on cloud", 1)
    ...
    Function populateCraftParameters(gui As Main) As BsonDocument
        ...
        'Catch ex As Exception
        '    gui.ChangeControlRichText(gui.RichTextBox1, "Populate Data Error", 3)
        '    gui.ChangeControlRichText(gui.RichTextBox1, ex.ToString, 1)
        'End Try
        'Return par
